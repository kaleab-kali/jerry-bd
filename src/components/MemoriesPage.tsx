...
export function MemoriesPage() {
  ...
  const memories: Memory[] = [
    ...
    { id: 40, title: "Our Journey So Far", subtitle: "2 Years, 1 Month, 24 Days", content: "The past 2 years, 1 month, and 24 days with you as my bestie have been a wild, amazing ride. Every goofy moment, every silly argument, every time we ghosted each other (oops!), and every laugh that made my sides hurt has built a friendship I treasure so much. We’ve had our ups and downs, but I wouldn’t change a thing. Thank you for being you and for making my days brighter. Here’s to us being the best BFFs for life—through all the chaos and good times. Happy Birthday, my favorite bestie!", type: "specialNote", image: "" }
  ]
